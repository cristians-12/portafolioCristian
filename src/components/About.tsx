    ...
    <section className='lg:flex justify-around items-center'>
      <section className='lg:w-[50%]'>
        ...
        <p className="text-2xl text-gray-400">
          ...
          área. Me enfoco en desarrollar código limpio, escalable y legible utilizando principios SOLID y
        ...
        <p className="text-2xl text-gray-400">
          ...
          aplicaciones escalables y de alto rendimiento. Además, tengo
